...
function my_scripts()
{
	...
	wp_enqueue_style('swiper-styles', get_stylesheet_directory_uri() . '/css/swiper-bundle.min.css', array(), $cssVersion);
	
	$jsVersion = filemtime(get_stylesheet_directory() . '/js/main.js');
	//var_dump(get_stylesheet_directory_uri() . '/js/main.js', $jsVersion);  

	wp_enqueue_script('swiper', get_stylesheet_directory_uri() . '/js/swiper-bundle.min.js', array(), false, true);
	wp_enqueue_script('main', get_stylesheet_directory_uri() . '/js/main.js', array('jquery', 'swiper' ), $jsVersion, true);
